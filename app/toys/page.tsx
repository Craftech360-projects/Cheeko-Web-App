...
export default function ToysPage() {
  ...
  const loadToys = async () => {
    try {
      ...
      const filteredToys = toysData.filter(toy => toy.name !== 'Cheeko Trial')
  ...
  const featureCards = [
    {
      ...
      description: 'Cheeko tailors stories to your child\'s pace for fun, ongoing growth.',
      icon: '🎯',
    },
    {
      title: 'Parental Dashboard',
      description: 'Track activity, set limits, and view learning insights with ease.',
      icon: '📊',
    },
    {
      title: 'Creative Content',
      description: 'Stories, games, and fun activities to spark young imaginations.',
      icon: '✨',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-white">
      <Navbar title={<Image src="/images/logo.png" alt="Cheeko" width={100} height={24} />} />
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {toys.map((toy) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-black mb-2">{toy.name}</h3>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-black">{toy.language || 'English'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-grey">Voice:</span>
                    <span className="text-black truncate ml-2">{toy.voice || 'Default'}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="space-y-8">
            ...
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold text-black mb-2">No toys yet</h2>
              <p className="text-grey mb-6">Add your first Cheeko toy to get started</p>
              <button
                onClick={() => router.push('/toys/activate')}
